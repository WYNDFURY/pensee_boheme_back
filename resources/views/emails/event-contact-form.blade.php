...
<head>
    ...
    <title>Nouvelle demande d'événement - Pensée Bohème</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Vous avez reçu une nouvelle demande d'événement de {{ $data['firstName'] }} {{ $data['lastName'] }} .</p>
        ...
        <div class="field">
            <div class="label">Lieu de l'événement :</div>
            <div class="value">{{ $data['eventLocation'] }}</div>
        </div>

        <div class="field">
            <div class="label">Couleurs/Thème :</div>
            <div class="value">{{ $data['themeColors'] }}</div>
        </div>
